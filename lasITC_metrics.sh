...
callDir="$PWD"
java -Xmx16g -XX:ParallelGCThreads=4 -XX:ConcGCThreads=4 -cp ".:$curDir/lib/*:$curDir/target/:$GDAL_JAVA_PATH/*" lasITC_metrics $@ 2> $callDir/lasITC_metrics_$current_datetime.log || [ ! -s $callDir/lasITC_metrics_$current_datetime.log ] && rm $callDir/lasITC_metrics_$current_datetime.log
