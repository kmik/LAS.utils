...
java -Xmx16g -XX:ParallelGCThreads=4 -XX:ConcGCThreads=4 -cp ".:$curDir/lib/*:$curDir/target/:$GDAL_JAVA_PATH/*" las2raster $@ 2> $callDir/las2raster_$current_datetime.log || [ ! -s $callDir/las2raster_$current_datetime.log ] && rm $callDir/las2raster_$current_datetime.log
