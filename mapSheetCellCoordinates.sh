...
callDir="$PWD"
java -Xms4g -Xmx32g -XX:ParallelGCThreads=8 -XX:ConcGCThreads=8 -cp ".:$curDir/lib/*:$curDir/target/:$GDAL_JAVA_PATH/*" mapSheetCellCoords $@ 2>&1 | tee $callDir/lasground_$current_datetime.log || [ ! -s $callDir/lasground_$current_datetime.log ] && rm $callDir/lasground_$current_datetime.log
