...
callDir="$PWD"
java -Xms4g -Xmx32g -XX:ParallelGCThreads=8 -XX:ConcGCThreads=8 -cp ".:$curDir/lib/*:$curDir/target/:$GDAL_JAVA_PATH/*" lasdz $@ 2>&1 | tee $callDir/lasdz_$current_datetime.log || [ ! -s $callDir/lasdz_$current_datetime.log ] && rm $callDir/lasdz_$current_datetime.log
