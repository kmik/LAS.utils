...
callDir="$PWD"
java -Xmx16g -XX:ParallelGCThreads=4 -XX:ConcGCThreads=4 -cp ".:$curDir/lib/*:$curDir/target/:$GDAL_JAVA_PATH/*" runners.RunLASutils 31 $@ 2>&1 | tee $callDir/lasStats_$current_datetime.log || [ ! -s $callDir/lasStats_$current_datetime.log ] && rm $callDir/lasStats_$current_datetime.log
