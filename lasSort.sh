...
callDir="$PWD"
java -Xmx16g -XX:ParallelGCThreads=4 -XX:ConcGCThreads=4 -cp ".:$curDir/lib/*:$curDir/target/:$GDAL_JAVA_PATH/*" lasSort $@ 2>&1 | tee $callDir/lasSort_$current_datetime.log || [ ! -s $callDir/lasSort_$current_datetime.log ] && rm $callDir/lasSort_$current_datetime.log
