...
callDir="$PWD"
java -Xmx16g -XX:ParallelGCThreads=4 -XX:ConcGCThreads=4 -cp ".:$curDir/lib/*:$curDir/target/:$GDAL_JAVA_PATH/*" lasITC $@ 2> $callDir/lasITC_$current_datetime.log || [ ! -s $callDir/lasITC_$current_datetime.log ] && rm $callDir/lasITC_$current_datetime.log
