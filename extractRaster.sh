...
callDir="$PWD"
java -Xmx16g -XX:ParallelGCThreads=4 -XX:ConcGCThreads=4 -cp ".:$curDir/lib/*:$curDir/target/:$GDAL_JAVA_PATH/*" extractRaster $@ 2>&1 | tee $callDir/las2las_$current_datetime.log || [ ! -s $callDir/las2las_$current_datetime.log ] && rm $callDir/las2las_$current_datetime.log
