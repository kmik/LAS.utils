...
callDir="$PWD"
java -Xmx16g -XX:ParallelGCThreads=4 -XX:ConcGCThreads=4 -cp ".:$curDir/lib/*:$curDir/target/:$GDAL_JAVA_PATH/*" tesselator $@ 2>&1 | tee $callDir/tesselator_$current_datetime.log || [ ! -s $callDir/tesselator_$current_datetime.log ] && rm $callDir/tesselator_$current_datetime.log
