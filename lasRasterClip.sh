...
callDir="$PWD"
java -Xmx16g -XX:ParallelGCThreads=4 -XX:ConcGCThreads=4 -cp ".:$curDir/lib/*:$curDir/target/:$GDAL_JAVA_PATH/*" lasRasterClip $@ 2> $callDir/lasRasterClip_$current_datetime.log || [ ! -s $callDir/lasRasterClip_$current_datetime.log ] && rm $callDir/lasRasterClip_$current_datetime.log
