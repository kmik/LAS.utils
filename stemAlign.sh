...
callDir="$PWD"
java -Xmx16g -XX:ParallelGCThreads=4 -XX:ConcGCThreads=4 -cp ".:$curDir/lib/*:$curDir/target/:$GDAL_JAVA_PATH/*" lasStemAlign $@ 2> $callDir/lasStemAlign_$current_datetime.log || [ ! -s $callDir/lasStemAlign_$current_datetime.log ] && rm $callDir/lasStemAlign_$current_datetime.log
