        ...
        if(aR.cores < 0){
            ...
            for (int i = 0; i < inputFiles.size(); i++) {
                ...
                try {
                    ...
                    Dataset raster = gdal.Open(inputFiles.get(i).getAbsolutePath(), gdalconst.GA_ReadOnly);

                    rasters.addRaster(new gdalRaster(raster.GetDescription(), i));
            ...
            for(int i = 0; i < rasters.rasters.size(); i++){
                ...
                raster.open();
                raster.retileRasterWithGeotransform(aR.odir, 32, 32, 16);
                raster.close();
