...
*/
        ...
        //aR.pointClouds = pointClouds;

        //aR.setPointClouds(pointClouds);
        aR.setInputFiles(inputFiles);

        //System.out.println(aR.pointClouds.size());
        ...
        if(aR.tool == 7){
            ...
            if(aR.cores > 1){
                ...
                for (int i = 0; i < filesList.size(); i++) {
                    ...
                    //createCHM.WaterShed fill = new createCHM.WaterShed(testi.treeTops, 0.2, testi.output2, testi);
