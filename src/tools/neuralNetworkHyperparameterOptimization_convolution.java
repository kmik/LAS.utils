...
public class neuralNetworkHyperparameterOptimization_convolution {
    ...
    public neuralNetworkHyperparameterOptimization_convolution(argumentReader aR) throws  Exception {
...
*/
        ...
        ParameterSpace<Double> dropoutParam= new ContinuousParameterSpace(0.1, 1.0);
...
*/
        ...
        public Object trainData() {
            try {
                //return this.trainIterator;// new MnistDataSetIterator(minibatchSize, true, 12345);
                return neuralNetworkHyperparameterOptimization_convolution.train_iter_multi;// new MnistDataSetIterator(minibatchSize, true, 12345);
        ...
        public Object testData() {
            try {
                ...
                //return this.testIterator;//MnistDataSetIterator(minibatchSize, false, 12345);
                return neuralNetworkHyperparameterOptimization_convolution.test_iter_multi;//MnistDataSetIterator(minibatchSize, false, 12345);
...
//recordReader.initialize(new FileSplit(new File("/home/koomikko/Documents/iris.csv")));
        ...
        public Object trainData() {
            try {
                //return this.trainIterator;// new MnistDataSetIterator(minibatchSize, true, 12345);
                return neuralNetworkHyperparameterOptimization_convolution.train_iter;// new MnistDataSetIterator(minibatchSize, true, 12345);
        ...
        public Object testData() {
            try {
                //return this.testIterator;//MnistDataSetIterator(minibatchSize, false, 12345);
                return neuralNetworkHyperparameterOptimization_convolution.test_iter;//MnistDataSetIterator(minibatchSize, false, 12345);
...
//recordReader.initialize(new FileSplit(new File("/home/koomikko/Documents/iris.csv")));
        ...
        public Object trainData() {
            try {
                //return this.trainIterator;// new MnistDataSetIterator(minibatchSize, true, 12345);
                return neuralNetworkHyperparameterOptimization_convolution.train_iter_2;// new MnistDataSetIterator(minibatchSize, true, 12345);
        ...
        public Object testData() {
            try {
                //return this.testIterator;//MnistDataSetIterator(minibatchSize, false, 12345);
                return neuralNetworkHyperparameterOptimization_convolution.test_iter_2;//MnistDataSetIterator(minibatchSize, false, 12345);
