...
public class ITDstatistics{
    ...
    public void profile(double[] treeTop, TFloatArrayList p2, int treeId) throws IOException{
        ...
        profileDistance = new double[(int)steps];
        profileDistanceMax = new double[(int)steps];
        profileSum = new double[(int)steps];
        profileThold = new double[(int)steps];

        double[] profile = new double[(int)steps];
        ...
        double minZ = maxPointZ * 0.5;  //Math.min(maxPointZ - minPointZ, 2.0);
...
*/
        ...
        double meanR = RGB[0] / (double)zetas.size();
        double meanG = RGB[1] / (double)zetas.size();
        double meanB = RGB[2] / (double)zetas.size();
 ...
 */
    ...
    public void labelTrees(){
        ...
        while(it.hasNext()){
            ...
            boolean isInside = Integer.parseInt(output.get(tem.getIndex()).split("\t")[output.get(tem.getIndex()).split("\t").length-1]) == 1;
    ...
    public boolean processPointCloud(LASReader pointCloud) throws IOException{
        ...
        THashMap<Integer, TFloatArrayList>  mappi13 = new THashMap<>();
        THashMap<Integer, TFloatArrayList>  mappi_smallerTrees = new THashMap<>();
        ...
        for(int i = 0; i < pointCloud.getNumberOfPointRecords(); i += 10000) {
            ...
            for (int j = 0; j < maxi; j++) {
                ...
                if(tempPoint.classification == 2 || tempPoint.classification == 1){
            ...
            for (int j = 0; j < maxi; j++) {
                ...
                if(tempPoint.classification == 8) {
                    ...
                    if(mappi_smallerTrees.containsKey(treeId)){
                        ...
                        mappi_smallerTrees.get(treeId).add((float)tempPoint.x);
                        mappi_smallerTrees.get(treeId).add((float)tempPoint.y);
                        mappi_smallerTrees.get(treeId).add((float)tempPoint.z);

                    }else{

                        mappi_smallerTrees.put(treeId, new TFloatArrayList());
                        mappi_smallerTrees.get(treeId).add((float)tempPoint.x);
                        mappi_smallerTrees.get(treeId).add((float)tempPoint.y);
                        mappi_smallerTrees.get(treeId).add((float)tempPoint.z);
                ...
                if(treeId > 0 && mappi2.containsKey(treeId)) {
                    ...
                    if(mappi13.containsKey(treeId)){
                        ...
                        mappi13.get(treeId).add((float)tempPoint.x);
                        mappi13.get(treeId).add((float)tempPoint.y);
                        mappi13.get(treeId).add((float)tempPoint.z);
                        mappi13.get(treeId).add((float)tempPoint.R);
                        mappi13.get(treeId).add((float)tempPoint.G);
                        mappi13.get(treeId).add((float)tempPoint.B);
                        mappi13.get(treeId).add((float)tempPoint.intensity);
                        mappi13.get(treeId).add((float)tempPoint.gpsTime);
                    }else{

                        mappi13.put(treeId, new TFloatArrayList());
                        mappi13.get(treeId).add((float)tempPoint.x);
                        mappi13.get(treeId).add((float)tempPoint.y);
                        mappi13.get(treeId).add((float)tempPoint.z);
                        mappi13.get(treeId).add((float)tempPoint.R);
