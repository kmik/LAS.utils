...
public class MortonZCurve {

    public static UInt32 EncodeM2D(UInt32 x, UInt32 y) {
        return Expand1((byte) ((new UInt32(y.byteValue() << 1).longValue() + new UInt32(
                x.byteValue()).longValue())));

    }

    public static UInt32 EncodeM3D(UInt32 x, UInt32 y, UInt32 z) {
    ...
    public static UInt32 DecodeM2X(UInt32 code) {
        return Shrink1((byte) (code.byteValue() >> 0));
    }

    public static UInt32 DecodeM2Y(UInt32 code) {
    ...
    // /////
    public static UInt32 DecodeM3X(UInt32 code) {
        return Shrink2((byte) (code.byteValue() >> 0));
    }

    public static UInt32 DecodeM3Y(UInt32 code) {
        return Shrink2((byte) (code.byteValue() >> 1));

    }

    public static UInt32 DecodeM3Z(UInt32 code) {
