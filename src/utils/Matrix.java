...
public class Matrix {
     ...
     * 					the
     */
    public static double[][][] singularValueDecomposition(double[][] input) {
     ...
     * 					input
     */
    public static EigenSet eigenDecomposition(double[][] input) {
     ...
     */
    public static double[] extractDiagonalEntries(double[][] input) {
     ...
     */
    public static double[][][] QRFactorize(double[][] input) {
     ...
     */
    public static double[][] gramSchmidt(double[][] input) {
     ...
     */
    public static double[][] GivensRotation(int size, int i, int j, double th) {
     ...
     */
    public static double[][] scale(double[][] mat, double coeff) {
     ...
     */
    public static double[] proj(double[] vec, double[] proj) {
    ...
    public static void print(double[][] matrix) {
        for(int j = 0; j < matrix[0].length; j++) {
            for(int i = 0; i < matrix.length; i++) {
                double formattedValue = Double.parseDouble(String.format("%.4f%n", matrix[i][j]));
