...
public class GeoTiffData {
    ...
    /**
     * Key code for the ProjectedCSTypeGeoKey specification
     */
  ...
  public static final int LinearUnitCodeFeetUS = 9003;
    ...
    public int getInteger(int[] keyCode) throws IOException {
        ...
        for(int i = 0; i < keyCode.length; i++){
            ...
            GeoTiffKey key = keyMap.get(keyCode[i]);
            if (key == null || key.location != 0) {
        ...
        throw new IOException("Invalid TIFF key for integer: " + Arrays.toString(keyCode));
    }
